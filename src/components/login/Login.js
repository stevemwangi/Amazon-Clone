...
function Login() {
    ...
    const register = (e) => {
        ...
        auth
            ...
            .then((auth) => {
                /** Created new user, redirect to homepage */
                history.push('/'); 
            })
            .catch((e)=> alert(e.message)); 
    }
    ...
    return (
        ...
        <div className="login__container">
            ...
            <form>
                ...
                <button onClick={login} type="submit" className="login__signInButton" onChange={e => setPassword(e.target.value)}>Sign In </button>
            </form>
            <p>By Signing in you agree to our Terms and Conditions. Please see our Privacy Policy for more info</p>
